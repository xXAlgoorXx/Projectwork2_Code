...
static const uint64_t __ec_params_memory_pool_base[3] = {
...
void trace_ec__ec_blob_1(void) {
  ...
  ec_trace_start_epoch(2);
  {
    ...
    /* Emit conf for STREAM_ENG_V2 node=Gemm_2_conv_4_suboff_6 input ports=0 range=1[0,1024] */
    ...
    /* Emit conf for STREAM_ENG_V2 node=Gemm_2_conv_4_suboff_6 output ports=0 range=1[1024,2048] */
    ...
    static const LL_Streng_TensorInitTypeDef Gemm_2_conv_4_suboff_6_dma_init_out_0_2 = {
      ...
      .align_right = 0,
      .nbits_unsigned = 1,
      .addr_base = {(unsigned char *)(0x342e0000UL) /* Equivalent hex address = 0x342e0000UL */}, /* Gemm_2_conv_4_zero_off_out_7 */
      .offset_start = 1024,
      .offset_end = 2048,
      .offset_limit = 2112,
      .frame_count = 0,
  ...
  ec_trace_start_epoch(3);
  {
    ...
    /* Emit conf for STREAM_ENG_V2 node=Gemm_2_conv_4 input ports=0 range=1[1024,2048] */
    ...
    /* Emit conf for STREAM_ENG_V2 node=Gemm_2_conv_4 input ports=1 range=7[0,1049088] */
    ...
    /* Emit conf for STREAM_ENG_V2 node=Gemm_2_conv_4_mul_scale_9 input ports=1 range=7[1049088,1051136] */
    ...
    static const LL_Streng_TensorInitTypeDef Gemm_2_conv_4_mul_scale_9_dma_init_in_1_3 = {
      ...
      .cacheable = 1,
      .cache_allocate = 0,
      .addr_base = {(unsigned char *)(0x70380000UL) /* Equivalent hex address = 0x70380000UL */}, /* Gemm_2_conv_4_mul_scale_11 */
    ...
    /* Dma output units from cycle: */
    /* Unit= 9 [STREAM_ENG_V2 9] */
    /* Emit conf for STREAM_ENG_V2 node=Gemm_2_conv_4_off_bias_12 output ports=0 range=1[0,1024] */
    ...
    /* Unit=STREAM_ENG_V2 */
    LL_Streng_TensorInit(9, &Gemm_2_conv_4_off_bias_12_dma_init_out_0_3, 1);
    ...
    static const LL_Switch_InitTypeDef switch_init_in_3[] = {
      ...
      { LL_Switch_Init_Dest() = ATONN_DSTPORT(STRSWITCH, 0, STRENG, 9, 0), LL_Switch_Init_Source(0) = ATONN_SRCPORT(STRSWITCH, 0, ARITH, 2, 0), LL_Switch_Init_Context(0) = 1, LL_Switch_Init_Frames(0) = 0, }, /* Gemm_2_conv_4_off_bias_12 OUT: in unit=STREAM_ENG_V2 9 in port=0 out unit=ARITH_ACC_V2 2 out port=0 */
    };
