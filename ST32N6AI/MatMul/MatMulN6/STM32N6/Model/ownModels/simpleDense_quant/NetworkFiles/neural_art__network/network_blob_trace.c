...
0x3E843E0C3ED93E53ULL,0x431E43CB44D839DEULL,0x00000000452D45C8ULL,0x0000000000000000ULL,0x0000000000000000ULL,0x0000000000000000ULL,0x0000000000000000ULL,
};
...
void trace_ec__ec_blob_1(void) {
  ...
  ec_trace_start_epoch(2);
  {
    ...
    /* Emit conf for STREAM_ENG_V2 node=Gemm_2_conv_4 input ports=1 range=7[0,100] */
