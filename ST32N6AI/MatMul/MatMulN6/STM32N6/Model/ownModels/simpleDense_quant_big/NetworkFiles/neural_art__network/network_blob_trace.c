...
static const uint64_t __ec_params_memory_pool_base[29] = {
0x5A005BAB5D815B3EULL,0x5C435A095A0F5DD2ULL,0x5D135C665CBB5EAAULL,0x55C659E65B3B5EA2ULL,0x5D3A5A9B5E255F49ULL,0x5E785F5F5CAA576BULL,0x5F3D5BEF5F155ADFULL,0x589C5DF95E5658D7ULL,
0x5D395C6D588B5C28ULL,0x5959585A5DC858A2ULL,0x57225B9E57FE5D2AULL,0x5E1B5C6A5A5A5B80ULL,0x5FBE59485CA15B54ULL,0x599A56C85F455B5AULL,0x5F4757AE5CA55EFDULL,0x5C9657A15D5D5F10ULL,
0x58635E985EC05C26ULL,0x5BDE58A25A0A5DCFULL,0x5E1A5DBD5CE15ACFULL,0x58EF5ACE5E3D5DE2ULL,0x5BD95C455F295892ULL,0x5CB25E805AEE5D86ULL,0x5DF658A55ED75DADULL,0x5DBA5DDB5BE75F6AULL,
0x5DA15E015B775EE4ULL,0x0000000000000000ULL,0x0000000000000000ULL,0x0000000000000000ULL,0x0000000000000000ULL,
};
...
void trace_ec__ec_blob_1(void) {
  ...
  ec_trace_start_epoch(2);
  {
    ...
    /* Emit conf for STREAM_ENG_V2 node=Gemm_2_conv_4_suboff_6 input ports=0 range=1[0,100] */

    static const LL_Streng_TensorInitTypeDef Gemm_2_conv_4_suboff_6_dma_init_in_0_2 = {
      /* from memory with batch=100 */
      .dir = 0,
      .raw = 1,
      .noblk = 0,
      .align_right = 0,
    ...
    /* Emit conf for STREAM_ENG_V2 node=Gemm_2_conv_4_suboff_6 output ports=0 range=1[112,212] */

    static const LL_Streng_TensorInitTypeDef Gemm_2_conv_4_suboff_6_dma_init_out_0_2 = {
      /* to memory with batch=100 */
      .dir = 1,
      .raw = 1,
      .noblk = 0,
      .align_right = 0,
  ...
  ec_trace_start_epoch(3);
  {
    ...
    /* Emit conf for STREAM_ENG_V2 node=Gemm_2_conv_4 input ports=0 range=1[112,212] */
    ...
    /* Emit conf for STREAM_ENG_V2 node=Gemm_2_conv_4 input ports=1 range=7[0,10005] */
    ...
    /* Emit conf for STREAM_ENG_V2 node=Gemm_2_conv_4_off_bias_12 output ports=0 range=1[0,100] */
    ...
    /* Unit=STREAM_ENG_V2 */
    LL_Streng_TensorInit(7, &Gemm_2_conv_4_off_bias_12_dma_init_out_0_3, 1);
    ...
    static const LL_Switch_InitTypeDef switch_init_in_3[] = {
      ...
      { LL_Switch_Init_Dest() = ATONN_DSTPORT(STRSWITCH, 0, STRENG, 7, 0), LL_Switch_Init_Source(0) = ATONN_SRCPORT(STRSWITCH, 0, ARITH, 2, 0), LL_Switch_Init_Context(0) = 1, LL_Switch_Init_Frames(0) = 0, }, /* Gemm_2_conv_4_off_bias_12 OUT: in unit=STREAM_ENG_V2 7 in port=0 out unit=ARITH_ACC_V2 2 out port=0 */
    };
