...
#define LL_ATON_DEFAULT_ORIGIN_MODEL_NAME   "quantized_model_big"
...
#define LL_ATON_DEFAULT_IN_1_SIZE_BYTES  (100)
...
#define LL_ATON_DEFAULT_OUT_1_SIZE_BYTES  (100)
