...
/** @defgroup ILI9341_Exported_Types ILI9341 Exported Types
  * @{
  */
typedef int32_t (*ILI9341_Write_Func)(void *, volatile uint8_t*, uint32_t);
typedef int32_t (*ILI9341_Read_Func) (void *, volatile uint8_t*, uint32_t);
...
typedef struct
{
  ...
  ILI9341_Send_Func    SendDataDMA;
  ILI9341_Recv_Func    RecvData;
  ILI9341_Recv_Func    RecvDataDMA;
  void                 *handle;
} ili9341_ctx_t;
/**
  * @}
