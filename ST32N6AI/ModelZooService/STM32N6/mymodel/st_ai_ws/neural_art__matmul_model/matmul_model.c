 ...
 * --onnx-input = "/home/lukasschoepf/Documents/ProjectWork_2/Projectwork2_Code/ST32N6AI/ModelZooService/STM32N6/mymodel/st_ai_output/matmul_two_inputs_model_OE_3_2_0.onnx"
 * --out-dir-prefix = "/home/lukasschoepf/Documents/ProjectWork_2/Projectwork2_Code/ST32N6AI/ModelZooService/STM32N6/mymodel/st_ai_ws/neural_art__matmul_model/"
 * --network-name = "matmul_model"
 * --all-buffers-info = true
 * --load-mdesc-file = "/opt/ST/STEdgeAI/2.1/Utilities/configs/stm32n6"
 * --load-mpool-file = "/home/lukasschoepf/Documents/ProjectWork_2/Projectwork2_Code/ST32N6AI/ModelZooService/STM32N6/mymodel/my_mpools/stm32n6-app2"
 * --cache-maintenance = true
 * --enable-virtual-mem-pools = true
 * --native-float = true
 * --json-quant-file = "/home/lukasschoepf/Documents/ProjectWork_2/Projectwork2_Code/ST32N6AI/ModelZooService/STM32N6/mymodel/st_ai_output/matmul_two_inputs_model_OE_3_2_0_Q.json"
 * --optimization = 3
 * --Os = true
 * --Omax-ca-pipe = 4
 * --Ocache-opt = true
...
LL_ATON_User_IO_Result_t LL_ATON_Set_User_Input_Buffer_matmul_model(uint32_t num, void* buffer, uint32_t size)
{
  { 
...
void *LL_ATON_Get_User_Input_Buffer_matmul_model(uint32_t num)
{
  { 
    return NULL;
  }
...
LL_ATON_User_IO_Result_t LL_ATON_Set_User_Output_Buffer_matmul_model(uint32_t num, void* buffer, uint32_t size)
{
  { 
    return LL_ATON_User_IO_WRONG_INDEX;
  }
...
void *LL_ATON_Get_User_Output_Buffer_matmul_model(uint32_t num)
{
  { 
    return NULL;
  }
...
#include "matmul_model_ecblobs.h"
...
const EpochBlock_ItemTypeDef *LL_ATON_EpochBlockItems_matmul_model(void) {
...
const LL_Buffer_InfoTypeDef *LL_ATON_Input_Buffers_Info_matmul_model(void)
{
...
const LL_Buffer_InfoTypeDef *LL_ATON_Output_Buffers_Info_matmul_model(void)
{
...
const LL_Buffer_InfoTypeDef *LL_ATON_Internal_Buffers_Info_matmul_model(void)
{
