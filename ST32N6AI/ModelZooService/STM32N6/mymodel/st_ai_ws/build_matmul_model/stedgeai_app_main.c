...
LL_ATON_DECLARE_NAMED_NN_INSTANCE_AND_INTERFACE(matmul_model) // Defines NN_Instance_matmul_model and NN_Interface_matmul_model with network.c info
...
int main(int argc, char* argv[])
{
  ...
  while(1)
  {
    LL_ATON_RT_Main(&NN_Instance_matmul_model);
  }
}
