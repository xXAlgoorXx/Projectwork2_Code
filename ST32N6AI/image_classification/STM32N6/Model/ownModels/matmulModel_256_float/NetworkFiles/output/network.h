...
#define LL_ATON_DEFAULT_ORIGIN_MODEL_NAME   "matmulModel_256_float"
...
#define LL_ATON_DEFAULT_IN_1_SIZE_BYTES  (1024)
...
#define LL_ATON_DEFAULT_OUT_1_SIZE_BYTES  (1024)
