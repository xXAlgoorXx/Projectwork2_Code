...
#define LL_ATON_DEFAULT_ORIGIN_MODEL_NAME   "matmulModel_128_int8"
...
#define LL_ATON_DEFAULT_IN_1_SIZE_BYTES  (128)
...
#define LL_ATON_DEFAULT_OUT_1_SIZE_BYTES  (128)
