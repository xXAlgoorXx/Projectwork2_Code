 ...
 * --onnx-input = "/home/lukasschoepf/Documents/ProjectWork_2/Projectwork2_Code/ST32N6AI/image_classification/STM32N6/Model/ownModels/matmulModel_17_10_int8/NetworkFiles/output/matmulModel_17_10_int8_OE_3_2_0.onnx"
 * --out-dir-prefix = "/home/lukasschoepf/Documents/ProjectWork_2/Projectwork2_Code/ST32N6AI/image_classification/STM32N6/Model/ownModels/matmulModel_17_10_int8/NetworkFiles/neural_art__network/"
 ...
 * --json-quant-file = "/home/lukasschoepf/Documents/ProjectWork_2/Projectwork2_Code/ST32N6AI/image_classification/STM32N6/Model/ownModels/matmulModel_17_10_int8/NetworkFiles/output/matmulModel_17_10_int8_OE_3_2_0_Q.json"
 * --optimization = 3
 * --Os = true
 * --Omax-ca-pipe = 4
 * --Ocache-opt = true
...
static void LL_ATON_Start_EpochBlock_2(const void *epoch_block)
{
  ...
  /* kind=Mul node=Gemm_2_conv_4_mul_scale_6 */
  static const LL_Arithacc_InitTypeDef Gemm_2_conv_4_mul_scale_6_init2 = {
    .rounding_x = 0,
    .saturation_x = 0,
    .round_mode_x = 0,
    .inbytes_x = 2,
    ...
    .B_scalar = 0,
    .C_scalar = 0,
    .A_vector = {((unsigned char *)(ATON_LIB_PHYSICAL_TO_VIRTUAL_ADDR(0x34200000UL + 176))) /* Equivalent hex address = 0x342000b0UL */},
    .B_vector = {0},
    .C_vector = {0},
  ...
  /* Unit=ARITH_ACC_V2 */
  LL_Arithacc_Init(0, &Gemm_2_conv_4_mul_scale_6_init2);


  /* Unit= 19 [ARITH_ACC_V2 1] */
  /* kind=Add node=Gemm_2_conv_4_off_bias_9 */
  static const LL_Arithacc_InitTypeDef Gemm_2_conv_4_off_bias_9_init2 = {
    .rounding_x = 0,
    .saturation_x = 0,
    .round_mode_x = 0,
    .inbytes_x = 2,
  ...
  /* Unit=ARITH_ACC_V2 */
  LL_Arithacc_Init(1, &Gemm_2_conv_4_off_bias_9_init2);


  /* Dma inputs units to cycle: */
  /* Unit= 9 [STREAM_ENG_V2 9] */
  /* Emit conf for STREAM_ENG_V2 node=Gemm_2_conv_4 input ports=0 range=6[224,241] */
  ...
  /* Unit=STREAM_ENG_V2 */
  LL_Streng_TensorInit(9, &Gemm_2_conv_4_dma_init_in_0_2, 1);

  /* Unit= 3 [STREAM_ENG_V2 3] */
  /* Emit conf for STREAM_ENG_V2 node=Gemm_2_conv_4 input ports=1 range=6[0,170] */
  ...
  /* Unit=STREAM_ENG_V2 */
  LL_Streng_TensorInit(3, &Gemm_2_conv_4_dma_init_in_1_2, 1);
  ...
  /* Emit conf for STREAM_ENG_V2 node=Gemm_2_conv_4_off_bias_9 output ports=0 range=6[256,266] */

  static const LL_Streng_TensorInitTypeDef Gemm_2_conv_4_off_bias_9_dma_init_out_0_2 = {
    ...
    .align_right = 0,
    .nbits_unsigned = 0,
    .addr_base = {(unsigned char *)(0x34200000UL) /* Equivalent hex address = 0x34200000UL */}, /* Gemm_2_conv_4_off_bias_out_10 */
    .offset_start = 256,
    .offset_end = 266,
    .offset_limit = 336,
    .frame_count = 0,
  ...
  /* Unit=STREAM_ENG_V2 */
  LL_Streng_TensorInit(7, &Gemm_2_conv_4_off_bias_9_dma_init_out_0_2, 1);
  ...
  static const LL_Switch_InitTypeDef switch_init_in_2[] = {
    { LL_Switch_Init_Dest() = ATONN_DSTPORT(STRSWITCH, 0, CONVACC, 0, 0), LL_Switch_Init_Source(0) = ATONN_SRCPORT(STRSWITCH, 0, STRENG, 9, 0), LL_Switch_Init_Context(0) = 1, LL_Switch_Init_Frames(0) = 0, }, /* Gemm_2_conv_4 IN: in unit=CONV_ACC_V2 0 in port=0 out unit=STREAM_ENG_V2 9 out port=0 */
    { LL_Switch_Init_Dest() = ATONN_DSTPORT(STRSWITCH, 0, CONVACC, 0, 1), LL_Switch_Init_Source(0) = ATONN_SRCPORT(STRSWITCH, 0, STRENG, 3, 0), LL_Switch_Init_Context(0) = 1, LL_Switch_Init_Frames(0) = 0, }, /* Gemm_2_conv_4 IN: in unit=CONV_ACC_V2 0 in port=1 out unit=STREAM_ENG_V2 3 out port=0 */
    { LL_Switch_Init_Dest() = ATONN_DSTPORT(STRSWITCH, 0, ARITH, 0, 0), LL_Switch_Init_Source(0) = ATONN_SRCPORT(STRSWITCH, 0, CONVACC, 0, 0), LL_Switch_Init_Context(0) = 1, LL_Switch_Init_Frames(0) = 0, }, /* Gemm_2_conv_4_mul_scale_6 IN: in unit=ARITH_ACC_V2 0 in port=0 out unit=CONV_ACC_V2 0 out port=0 */
    { LL_Switch_Init_Dest() = ATONN_DSTPORT(STRSWITCH, 0, ARITH, 1, 0), LL_Switch_Init_Source(0) = ATONN_SRCPORT(STRSWITCH, 0, ARITH, 0, 0), LL_Switch_Init_Context(0) = 1, LL_Switch_Init_Frames(0) = 0, }, /* Gemm_2_conv_4_off_bias_9 IN: in unit=ARITH_ACC_V2 1 in port=0 out unit=ARITH_ACC_V2 0 out port=0 */
    { LL_Switch_Init_Dest() = ATONN_DSTPORT(STRSWITCH, 0, STRENG, 7, 0), LL_Switch_Init_Source(0) = ATONN_SRCPORT(STRSWITCH, 0, ARITH, 1, 0), LL_Switch_Init_Context(0) = 1, LL_Switch_Init_Frames(0) = 0, }, /* Gemm_2_conv_4_off_bias_9 OUT: in unit=STREAM_ENG_V2 7 in port=0 out unit=ARITH_ACC_V2 1 out port=0 */
  };
...
const LL_Buffer_InfoTypeDef *LL_ATON_Input_Buffers_Info_Default(void)
{
  ...
  static const float buff_info_Input_0_out_0_quant_scale[] = { 0.00780049385502934 };
  static const int16_t buff_info_Input_0_out_0_quant_offset[] = { 0 };
#if LL_ATON_DBG_BUFFER_INFO_EXCLUDED == 0
  static const uint32_t buff_info__shape_10_17_1_1[] = { 10, 1, 1, 17 };
  static const uint32_t buff_info__mem_shape_F_10_17_1_1[] = { 10, 17, 1, 1 };
  static const float buff_info_Gemm_2_weights_transposed_3_quant_scale[] = { 0.00711947539821267, 0.00771324383094907, 0.00756237842142582, 0.00779158854857087, 0.00744340103119612, 0.00739204231649637, 0.00610850006341934, 0.00767963612452149, 0.00714462297037244, 0.0078035001643002 };
  ...
  static const LL_Buffer_InfoTypeDef buff_info[] = {
...
#if LL_ATON_DBG_BUFFER_INFO_EXCLUDED == 0
    {
      ...
      .epoch = 0,
      .batch = 17,
      .mem_shape = buff_info__mem_shape_F_10_17_1_1,
      .mem_ndims = 4,
      .chpos = CHPos_First,
      .Qm = 7,
      .Qn = 0,
    ...
    {
      .name = "Gemm_2_conv_4_off_bias_11",
      .addr_base = {(unsigned char *)(0x34200000UL) /* Equivalent hex address = 0x34200000UL */},
      .offset_start = 208,
      .offset_end = 210,
      .offset_limit = 280,
...
const LL_Buffer_InfoTypeDef *LL_ATON_Output_Buffers_Info_Default(void)
{
  ...
  static const float buff_info_Quantize_3_out_0_quant_scale[] = { 0.0194288808852434 };
  static const int16_t buff_info_Quantize_3_out_0_quant_offset[] = { 13 };
  static const LL_Buffer_InfoTypeDef buff_info[] = {
    {
...
{
  static const uint32_t buff_info__shape_1_17_1_1[] = { 1, 1, 1, 17 };
  static const uint32_t buff_info__mem_shape_F_1_17_1_1[] = { 1, 17, 1, 1 };
  static const float buff_info_Gemm_2_reshape_x_2_quant_scale[] = { 0.00780049385502934 };
  static const int16_t buff_info_Gemm_2_reshape_x_2_quant_offset[] = { 0 };
  static const uint32_t buff_info__shape_1_10_1_1[] = { 1, 1, 1, 10 };
  static const uint32_t buff_info__mem_shape_F_1_10_1_1[] = { 1, 10, 1, 1 };
  static const float buff_info_Gemm_2_conv_4_off_bias_out_10_quant_scale[] = { 0.0194288808852434 };
  static const int16_t buff_info_Gemm_2_conv_4_off_bias_out_10_quant_offset[] = { 13 };
  static const LL_Buffer_InfoTypeDef buff_info[] = {
    {
      ...
      .epoch = 1,
      .batch = 17,
      .mem_shape = buff_info__mem_shape_F_1_17_1_1,
      .mem_ndims = 4,
      .chpos = CHPos_First,
      .Qm = 7,
      .Qn = 0,
    ...
    },
    {
      ...
      .per_channel = 0,
      .scale = buff_info_Gemm_2_conv_4_off_bias_out_10_quant_scale,
      .offset = buff_info_Gemm_2_conv_4_off_bias_out_10_quant_offset,
    },
    {
      .name = NULL,
    }
