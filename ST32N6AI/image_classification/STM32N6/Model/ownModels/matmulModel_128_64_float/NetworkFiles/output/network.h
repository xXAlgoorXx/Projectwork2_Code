...
#define LL_ATON_DEFAULT_ORIGIN_MODEL_NAME   "matmulModel_128_64_float"
...
#define LL_ATON_DEFAULT_IN_1_SIZE_BYTES  (512)

/************************** OUTPUTS *******************************************/
#define LL_ATON_DEFAULT_OUT_NUM        (1)    // Total number of output buffers
// Output buffer 1 -- Gemm_1_out_0
#define LL_ATON_DEFAULT_OUT_1_ALIGNMENT   (32)
#define LL_ATON_DEFAULT_OUT_1_SIZE_BYTES  (256)
