 ...
 * --onnx-input = "/home/lukasschoepf/Documents/ProjectWork_2/Projectwork2_Code/ST32N6AI/image_classification/STM32N6/Model/testing/matmulModel_32_int8_OE_3_2_0.onnx"
 * --out-dir-prefix = "/home/lukasschoepf/Documents/ProjectWork_2/Projectwork2_Code/ST32N6AI/image_classification/STM32N6/Model/testing/ws/neural_art__network/"
 ...
 * --w-bits = 8
 * --f-bits = 8
 * --json-quant-file = "/home/lukasschoepf/Documents/ProjectWork_2/Projectwork2_Code/ST32N6AI/image_classification/STM32N6/Model/testing/matmulModel_32_int8_OE_3_2_0_Q.json"
...
static void LL_ATON_Start_EpochBlock_2(const void *epoch_block)
{
  ...
  /* Emit conf for STREAM_ENG_V2 node=Gemm_2_conv_4_suboff_6 input ports=0 range=1[1136,1168] */
  ...
  /* Emit conf for STREAM_ENG_V2 node=Gemm_2_conv_4_suboff_6 output ports=0 range=1[1168,1200] */
...
static void LL_ATON_Start_EpochBlock_3(const void *epoch_block)
{
  ...
  static const LL_Arithacc_InitTypeDef Gemm_2_conv_4_mul_scale_9_init3 = {
    ...
    .B_scalar = 0,
    .C_scalar = 0,
    .A_vector = {((unsigned char *)(ATON_LIB_PHYSICAL_TO_VIRTUAL_ADDR(0x342e0000UL + 1040))) /* Equivalent hex address = 0x342e0410UL */},
    .B_vector = {0},
    .C_vector = {0},
  ...
  /* Emit conf for STREAM_ENG_V2 node=Gemm_2_conv_4 input ports=0 range=1[1168,1200] */
  ...
  /* Emit conf for STREAM_ENG_V2 node=Gemm_2_conv_4 input ports=1 range=1[0,1026] */
  ...
  /* Emit conf for STREAM_ENG_V2 node=Gemm_2_conv_4_off_bias_12 output ports=0 range=1[1136,1168] */
