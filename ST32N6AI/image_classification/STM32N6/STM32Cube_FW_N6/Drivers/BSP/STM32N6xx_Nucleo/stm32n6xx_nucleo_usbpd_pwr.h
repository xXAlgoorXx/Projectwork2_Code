/**
  ******************************************************************************
  * @file    stm32n6xx_nucleo_usbpd_pwr.h
  * @author  MCD Application Team
  * @brief   Header file for stm32n6xx_nucleo_usbpd_pwr.c file
  ******************************************************************************
  * @attention
  *
...
#define STM32N6XX_NUCLEO_USBPD_PWR_H
...
/** @defgroup STM32N6XX_NUCLEO_USBPD_PWR USBPD_PWR
  * @{
  */

/** @defgroup STM32N6XX_NUCLEO_USBPD_PWR_Exported_Types Exported Types
  * @{
  */
...
/** @defgroup STM32N6XX_NUCLEO_USBPD_PWR_Exported_Constants Exported Constants
  * @{
  */
/**
...
/**
  ...
  */
#define TCPP0203_PORT0_ENABLE_GPIO_CLK_ENABLE()     LL_AHB4_GRP1_EnableClock(LL_AHB4_GRP1_PERIPH_GPIOA)
#define TCPP0203_PORT0_ENABLE_GPIO_CLK_DISABLE()    LL_AHB4_GRP1_DisableClock(LL_AHB4_GRP1_PERIPH_GPIOA)
#define TCPP0203_PORT0_ENABLE_GPIO_PORT             GPIOA
#define TCPP0203_PORT0_ENABLE_GPIO_PIN              LL_GPIO_PIN_7
...
/** @addtogroup STM32N6XX_NUCLEO_USBPD_PWR_Exported_Variables
  * @{
  */
/**
  * @}
...
/** @defgroup STM32N6XX_NUCLEO_USBPD_PWR_Exported_Functions Exported Functions
  * @{
  */
/* Common functions */
