/**
  ...
  *          with devices available on STM32N6570-Nucleo board (MB1940) from
  *          STMicroelectronics
  ******************************************************************************
  * @attention
  *
...
/** @defgroup STM32N6XX_NUCLEO_BUS BUS
  * @{
  */

/** @defgroup STM32N6XX_NUCLEO_BUS_Private_Constants Private Constants
  * @{
  */
...
/** @defgroup STM32N6XX_NUCLEO_BUS_Private_Types Private Types
  * @{
  */
typedef struct
{
...
/** @addtogroup STM32N6XX_NUCLEO_BUS_Private_Constants
  * @{
  */
...
/** @defgroup STM32N6XX_NUCLEO_BUS_Private_Variables Private Variables
  * @{
  */
...
/** @defgroup STM32N6XX_NUCLEO_BUS_Exported_Variables Exported Variables
  * @{
  */
...
/** @defgroup STM32N6XX_NUCLEO_BUS_Private_FunctionPrototypes BUS Private FunctionPrototypes
  * @{
  */
static void I2C2_MspInit(const I2C_HandleTypeDef *phi2c);
static void I2C2_MspDeInit(const I2C_HandleTypeDef *phi2c);
...
/** @defgroup STM32N6XX_NUCLEO_BUS_Exported_Functions Exported Functions
  * @{
  */
...
/** @defgroup STM32N6XX_NUCLEO_BUS_Private_Functions Private Functions
  * @{
  */
/**
