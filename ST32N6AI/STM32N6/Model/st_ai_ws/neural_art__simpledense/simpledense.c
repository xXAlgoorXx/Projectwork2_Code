 ...
 * --out-dir-prefix = "/home/lukasschoepf/Documents/ProjectWork_2/Projectwork2_Code/ST32N6AI/STM32N6/Model/st_ai_ws/neural_art__simpledense/"
 * --network-name = "simpledense"
...
LL_ATON_User_IO_Result_t LL_ATON_Set_User_Input_Buffer_simpledense(uint32_t num, void* buffer, uint32_t size)
{
  { 
...
void *LL_ATON_Get_User_Input_Buffer_simpledense(uint32_t num)
{
  { 
    return NULL;
  }
...
LL_ATON_User_IO_Result_t LL_ATON_Set_User_Output_Buffer_simpledense(uint32_t num, void* buffer, uint32_t size)
{
  { 
    return LL_ATON_User_IO_WRONG_INDEX;
  }
...
void *LL_ATON_Get_User_Output_Buffer_simpledense(uint32_t num)
{
  { 
    return NULL;
  }
...
const EpochBlock_ItemTypeDef *LL_ATON_EpochBlockItems_simpledense(void) {
...
const LL_Buffer_InfoTypeDef *LL_ATON_Input_Buffers_Info_simpledense(void)
{
...
const LL_Buffer_InfoTypeDef *LL_ATON_Output_Buffers_Info_simpledense(void)
{
  static const uint32_t buff_info__shape_1_10[] = { 1, 1, 10, 1 };
  static const uint32_t buff_info__mem_shape_U_1_10[] = { 1, 10 };
...
const LL_Buffer_InfoTypeDef *LL_ATON_Internal_Buffers_Info_simpledense(void)
{
