...
mpool_reloc_info_t mpool_reloc_info[] = {
  {"AXISRAM6", "_mem_pool_AXISRAM6_two_inputs_matmul", 0x34350000, 1, 0},
  {"AXISRAM5", "_mem_pool_AXISRAM5_two_inputs_matmul", 0x342e0000, 1, 0},
  {"AXISRAM4", "_mem_pool_AXISRAM4_two_inputs_matmul", 0x34270000, 1, 0},
  {"AXISRAM3", "_mem_pool_AXISRAM3_two_inputs_matmul", 0x34200000, 1, 0},
  {"AXISRAM2", "_mem_pool_AXISRAM2_two_inputs_matmul", 0x34100000, 1, 0},
  {"AXISRAM1", "_mem_pool_AXISRAM1_two_inputs_matmul", 0x34080000, 1, 0},
  {"AXIFLEXMEM", "_mem_pool_AXIFLEXMEM_two_inputs_matmul", 0x34000000, 1, 0},
  {"xSPI1", "_mem_pool_xSPI1_two_inputs_matmul", 0x90000000, 1, 0},
  {"xSPI2", "_mem_pool_xSPI2_two_inputs_matmul", 0x70380000, 1, 0},
  {"AXISRAM2_AXISRAM3_AXISRAM4_AXISRAM5_AXISRAM6", "_mem_pool_AXISRAM2_AXISRAM3_AXISRAM4_AXISRAM5_AXISRAM6_two_inputs_matmul", 0x34100000, 1, 0},
  {NULL, NULL, 0, 0, 0}
};
...
int main () {
  ec_trace_init("two_inputs_matmul_ecblobs.h", "two_inputs_matmul");
  trace_ec__ec_blob_1();
  trace_ec__ec_blob_4();
