...
LL_ATON_DECLARE_NAMED_NN_INSTANCE_AND_INTERFACE(two_inputs_matmul) // Defines NN_Instance_two_inputs_matmul and NN_Interface_two_inputs_matmul with network.c info

AI_ALIGNED(32)
static ai_u8 activations_1[0];
AI_ALIGNED(32)
static ai_u8 activations_2[112];
AI_ALIGNED(32)
...
int main(int argc, char* argv[])
{
  ...
  while(1)
  {
    LL_ATON_RT_Main(&NN_Instance_two_inputs_matmul);
  }
}
