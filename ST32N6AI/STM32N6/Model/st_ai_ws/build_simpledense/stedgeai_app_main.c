...
LL_ATON_DECLARE_NAMED_NN_INSTANCE_AND_INTERFACE(simpledense) // Defines NN_Instance_simpledense and NN_Interface_simpledense with network.c info

AI_ALIGNED(32)
static ai_u8 activations_1[0];
AI_ALIGNED(32)
static ai_u8 activations_2[26];
AI_ALIGNED(32)
...
int main(int argc, char* argv[])
{
  ...
  while(1)
  {
    LL_ATON_RT_Main(&NN_Instance_simpledense);
  }
}
