...
LL_ATON_User_IO_Result_t LL_ATON_Set_User_Input_Buffer_Size32(uint32_t num, void* buffer, uint32_t size)
{
  {
...
void *LL_ATON_Get_User_Input_Buffer_Size32(uint32_t num)
{
  {
    return NULL;
  }
...
LL_ATON_User_IO_Result_t LL_ATON_Set_User_Output_Buffer_Size32(uint32_t num, void* buffer, uint32_t size)
{
  {
    return LL_ATON_User_IO_WRONG_INDEX;
  }
...
void *LL_ATON_Get_User_Output_Buffer_Size32(uint32_t num)
{
  {
    return NULL;
  }
...
bool LL_ATON_EC_Network_Init_Size32(void)
{
  return true;
}

bool LL_ATON_EC_Inference_Init_Size32(void)
{
  return true;
}
...
const EpochBlock_ItemTypeDef *LL_ATON_EpochBlockItems_Size32(void) {
...
const LL_Buffer_InfoTypeDef *LL_ATON_Input_Buffers_Info_Size32(void)
{
...
const LL_Buffer_InfoTypeDef *LL_ATON_Output_Buffers_Info_Size32(void)
{
  static const uint32_t buff_info__shape_1_16[] = { 1, 1, 16, 1 };
  static const uint32_t buff_info__mem_shape_U_1_16[] = { 1, 16 };
...
const LL_Buffer_InfoTypeDef *LL_ATON_Internal_Buffers_Info_Size32(void)
{
