...
#define LL_ATON_DEFAULT_ORIGIN_MODEL_NAME   "matmul_model"
...
#define LL_ATON_DEFAULT_IN_1_SIZE_BYTES  (4)
// Input buffer 2 -- Input_0_out_0
#define LL_ATON_DEFAULT_IN_2_ALIGNMENT   (32)
#define LL_ATON_DEFAULT_IN_2_SIZE_BYTES  (4)
